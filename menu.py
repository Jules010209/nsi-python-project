...
# Exemple de base de donnée pour les tests
# FR = Français, EN = Anglais, PE = Sport
db = [
...
if commandKey == 0:  # Quitte le programme
    exit()
elif commandKey == 1: #Ajouter un/des élèves
...
elif commandKey == 2: # Modifier le nom de l'élève
    ...
    try:
        ...
        print(e)
elif commandKey == 3: #Ajouter des notes à un élève
    fr = []
    en = []
    pe = []
...
elif commandKey == 4:  # Modifier les notes d'un élève
    fr = []
    en = []
    pe = []
    studentName = input("Nom de l'élève ")
    ...
    print(f"Vous avez ajouté {notes}")
elif commandKey == 5: # Suprimmer un élève 
